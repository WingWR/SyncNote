...
import com.syncnote.ai.provider.TheAiProvider;
...
public class AIServiceImpl implements IAIService {
    ...
    public ChatResponse processChat(ChatRequest request) {
        ...
        TheAiProvider provider = providerRegistry.getProvider(request.getModelId())
    ...
    public List<ModelInfo> getAvailableModels() {
        ...
        Map<String, TheAiProvider> providers = providerRegistry.getAllProviders();
